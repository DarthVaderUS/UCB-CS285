...
def run_training_loop(logger, args):
    ...
    for itr in range(args.n_iter):
        ...
        # compute total number of environment steps this batch and add it to the total environment steps so far
        ...
        # trajs_dict keys come from `infrastructure.utils.sample_trajectory()`
        # which uses keys: 'observation', 'action', 'reward', 'next_observation', 'terminal'
